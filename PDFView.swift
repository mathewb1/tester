...
struct PDFView: View {
    ...
    private func generatePDF() {
        ...
        // A4 Landscape dimensions (72 points per inch)

        let pageWidth: CGFloat = 841.89  // 11.69 inches

        let pageHeight: CGFloat = 595.28 // 8.27 inches
        ...
        let data = renderer.pdfData { context in
            ...
            // Define table headers with adjusted widths for landscape
